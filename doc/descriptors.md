# Support for Output Descriptors in Felicoin Core

Since Felicoin Core v0.17, there is support for Output Descriptors. This is a
...
on Felicoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Felicoin Core wallets, a convenience function `combo` is
