Felicoin Core version *0.15.1* is now available from:

  <https://download.felicoin.org/felicoin-0.15.1/>
...
A number of changes to the way Felicoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 rabelos per kB (0.00001 KHS). This is to prepare for dropping the minimum transaction fee to 0.1 rabelos per kB (0.0001 KHS) in the next release.
