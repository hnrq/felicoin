...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " felicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  felicoin-tx [options] <hex-tx> [commands]  Update hex-encoded felicoin transaction\n" +
            "or:     felicoin-tx [options] -create [commands]   Create hex-encoded felicoin transaction\n" +
            "\n";
