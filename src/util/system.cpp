...
const char * const BITCOIN_CONF_FILENAME = "felicoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Felicoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Felicoin";
#else
    // Unix
    return pathRet / ".felicoin";
#endif
#endif
}
