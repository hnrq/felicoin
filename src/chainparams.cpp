...
{
    const char* pszTimestamp = "Twitter 11/Mar/2021 Tsc... :| Telegram.go(); (y)";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 3.0 * 24 * 60 * 60; // 3.5 days
        ...
        vSeeds.emplace_back("seed-a.felicoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.felicointools.com");
        vSeeds.emplace_back("dnsseed.felicoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.felicointools.com");
        vSeeds.emplace_back("seed-b.felicoin.loshan.co.uk");
