...
"""Verify that starting felicoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start felicoin with -h for help text")
        ...
        self.log.info("Start felicoin with -version for version information")
        ...
        self.log.info("Start felicoind with -fakearg to make sure it does not start")
